      ...
      <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:p-10  shadow rounded '>
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          {loading && ( <div className='absolute right-0 top-0 bottom-0 left-0 flex items-center justify-center bg-black/10 mt-2'>
             ...
             <button disabled={loading} className='absolute bottom-1 right-2 ml-2 text-xs text-white bg-black/70 px-4 py-1.5 rounded hover:underline cursor-pointer' onClick={generateContent} type='button'>
             Generate with AI
             </button>
          </div>     
          ...
          {/* category and publish  */}
           ...
           <select onChange={e=> setCategory(e.target.value)} className='mt-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded' name="category" id="">
